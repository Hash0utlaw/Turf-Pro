    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <button className="bg-turf-green hover:bg-turf-green-dark text-white px-8 py-4 text-lg font-semibold rounded-lg transition-colors">
      ...
      <section className="py-16 bg-turf-green-extralight">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="bg-turf-green hover:bg-turf-green-dark text-white px-10 py-4 text-xl font-semibold rounded-lg transition-colors">
