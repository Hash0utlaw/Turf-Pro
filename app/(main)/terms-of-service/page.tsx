...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Terms of Service | Atlantic Turf Specialists",
    description: "Read the Terms of Service for using the Atlantic Turf Specialists website and services.",
    robots: {
      index: true,
      follow: true,
    },
      ...
      <section className="py-12 md:py-16">
        <div className="container px-4 md:px-6 max-w-3xl mx-auto prose prose-lg prose-headings:text-turf-green-dark prose-a:text-turf-green hover:prose-a:text-turf-green-dark">
          ...
          <ul>
            ...
            <li>
              To impersonate or attempt to impersonate Atlantic Turf Specialists, a Atlantic Turf Specialists employee, another user,
            ...
            <li>
              ...
              which, as determined by us, may harm or offend Atlantic Turf Specialists or users of the Service or expose them
              to liability.
            </li>
          </ul>
          ...
          <p>
            ...
            and will remain the exclusive property of Atlantic Turf Specialists and its licensors. The Service is protected by
          ...
          <p>
            Atlantic Turf Specialists has no control over, and assumes no responsibility for the content, privacy policies, or
            practices of any third-party web sites or services. We do not warrant the offerings of any of these
            entities/individuals or their websites.
          </p>
          <p>
            You acknowledge and agree that Atlantic Turf Specialists shall not be responsible or liable, directly or
