...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    openGraph: {
      title: "Comprehensive Artificial Turf Services | Atlantic Turf Specialists",
      description: "Discover all the ways Atlantic Turf Specialists can transform your outdoor and indoor spaces with premium turf.",
      images: [
        {
      ...
      <section className="py-12 md:py-20 bg-brand-gray-light">
        <div className="container px-4 md:px-6 text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-brand-gray-text md:text-xl">
            Discover how Atlantic Turf Specialists can transform your space with our wide range of premium artificial turf
            solutions.
          </p>
        </div>
      </section>
