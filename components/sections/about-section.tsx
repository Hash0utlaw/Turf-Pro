          ...
          <div className="order-2 md:order-1 flex items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-4 rounded-2xl bg-turf-green-extralight border border-turf-green/40 p-10 w-full aspect-square max-w-sm">
              <span className="flex flex-col items-start gap-[5px]" aria-hidden="true">
                ...
                <span className="block h-[6px] w-8 rounded-full bg-turf-green" />
              </span>
              <p className="text-3xl font-bold tracking-tight text-foreground uppercase text-center mt-2">
                Atlantic Turf
              </p>
              <p className="text-sm font-semibold tracking-[0.25em] text-turf-green uppercase text-center">
                Specialist
              </p>
            </div>
          </div>
